...
if(CMAKE_SYSTEM_NAME STREQUAL "iOS")
  if(CMAKE_OSX_SYSROOT MATCHES "[Ss]imulator")
    set(LOLHTML_RUST_TARGET "aarch64-apple-ios-sim")
  else()
    set(LOLHTML_RUST_TARGET "aarch64-apple-ios")
  endif()
...
if(CMAKE_SYSTEM_NAME STREQUAL "iOS")
  find_program(RUSTUP_RUSTC rustc PATHS $ENV{HOME}/.rustup/toolchains/1.92.0-aarch64-apple-darwin/bin NO_DEFAULT_PATH)
  if(RUSTUP_RUSTC)
    list(APPEND LOLHTML_ENV RUSTC=${RUSTUP_RUSTC})
  endif()
endif()
