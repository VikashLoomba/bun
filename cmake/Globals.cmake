...
function(register_cmake_command)
  ...
  if(CMAKE_SYSTEM_NAME STREQUAL "iOS")
    list(APPEND MAKE_EFFECTIVE_ARGS "-DCMAKE_SYSTEM_NAME=iOS")
    list(APPEND MAKE_EFFECTIVE_ARGS "-DCMAKE_SYSTEM_PROCESSOR=arm64")
    list(APPEND MAKE_EFFECTIVE_ARGS "-DCMAKE_OSX_SYSROOT=${CMAKE_OSX_SYSROOT}")
    list(APPEND MAKE_EFFECTIVE_ARGS "-DCMAKE_OSX_ARCHITECTURES=${CMAKE_OSX_ARCHITECTURES}")
    list(APPEND MAKE_EFFECTIVE_ARGS "-DCMAKE_OSX_DEPLOYMENT_TARGET=${CMAKE_OSX_DEPLOYMENT_TARGET}")
  endif()
