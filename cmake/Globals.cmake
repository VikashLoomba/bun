...
function(register_cmake_command)
  ...
  if(CMAKE_SYSTEM_NAME STREQUAL "iOS")
    # For iOS: don't pass host-detected CMAKE_ARGS (macOS sysroot, host compilers)
    # — the toolchain file provides everything sub-projects need
    set(MAKE_EFFECTIVE_ARGS -B${MAKE_BUILD_PATH})
  else()
  ...
  if(CMAKE_SYSTEM_NAME STREQUAL "iOS" AND DEFINED CMAKE_TOOLCHAIN_FILE)
    list(APPEND MAKE_EFFECTIVE_ARGS "-DCMAKE_TOOLCHAIN_FILE=${CMAKE_TOOLCHAIN_FILE}")
    list(APPEND MAKE_EFFECTIVE_ARGS "-DCMAKE_MACOSX_BUNDLE=OFF")
  endif()
